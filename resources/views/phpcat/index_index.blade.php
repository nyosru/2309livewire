@if (1 == 2)
    <div class="container">
        <div class="row">
            <div class="col-12 flex flex-wrap"><!--v-if-->
        ...
        <section class="background-radial-gradient xmb-40">
            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-full md:w-1/2">
                    <div class="p-2 min-h-[250px]">
                        <iframe class="w-full mx-auto"
                                src="https://vkvideo.ru/video_ext.php?oid=-169467193&id=456239017&hash=1d44088ef08e5f99&hd=1"
{{--                                width="100%"--}}
{{--                                width="640" --}}
height="360"
                ...
                <div class="w-full md:w-1/2 flex items-center justify-center px-4">
                    <h1
                        class="mt-0 mb-16
                            text-2xl font-bold
                            text-center
                            tracking-tight md:text-4xl xl:text-5xl
                            text-[rgb(118,11%,25%)]">
                    ...
                    <div class="grid items-center gap-12 lg:grid-cols-2">
                        <div class="mt-12 lg:mt-0 text-center">
                            ...
                            <p class="text-center text-xl font-bold md:text-2xl xl:text-3xl"> Я&nbsp;Сергей&nbsp;Бакланов
                                ...
                                <br><br>
                                Использую PHP, Laravel<sup>❤️</sup>, ИИ, Yii2, Битрикс, Symfony, js, LiveWire, Vue3,
                                Python, Git, Линтеры, Docker и&nbsp;вообще

                    ...
                    <div class="w-full shrink-0 grow-0 basis-auto x-lg:w-6/12 x-xl:w-8/12">
                        <div class="px-6 py-12 md:px-12">
                            ...
                            <div class="additional-fields"
                                 style="{{ $showAdditionalFields ? 'display: block;' : 'display: none;' }}">
                                <div class="text-[1.5rem] mb-1">
                                <span class="inline-block w-[30%] text-right">
                                Как Вас зовут:
                                    </span>
                                    <input type="text"
...
{{--                                        <a href="https://www.tinkoff.ru/rm/baklanov.sergey34/i4J5b154"--}}
                                   ...
                                   x-float-right
                                   rounded
                                   text-blue-800 hover:bg-blue-400" target="_blank">Отправить!</button>
                                </div>
                                </p>

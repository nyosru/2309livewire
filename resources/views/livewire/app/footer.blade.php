...
{{--                    text-gray-400--}}
                    ...
                    <div class="w-full md:w-1/4">
                        ...
                        <ul class="space-y-2">
                            <li>
                                <a href="#" class="p-1 hover:underline cursor-pointer" title="Позвонить"><img src="/icon/Phone.png" class="inline pr-2 max-h-[36px]"/>8-999-888-77-66</a></li>
                            <div
{{--                                class="flex flex-row flex-wrap text-center"--}}
                            >
                                <div class="text-center w-full flex flex-wrap justify-center space-x-1 " >
                                <a href="#"
                                   title="Телеграм"

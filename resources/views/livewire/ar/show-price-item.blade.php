<div>
    ...
    @foreach( $data as $op )
        ...
        <pre>
        {{ print_r($op->getAttributes(),true) }}
        </pre>

        @foreach( $op->man as $m )
            <div class="bg-yellow-300 xinline mr-2 border border-1 text-sm" style="max-width: 250px; overflow-x: auto;">
                man
                <pre>
        {{ print_r($m->getAttributes(),true) }}
        </pre>
            </div>
        @endforeach

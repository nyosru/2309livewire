<div>
    ...
    <header class="bg-white shadow">
        ...
        <div class="w-full h-[40vh] max-h-[600px] bg-cover bg-center bg-no-repeat"
             style="background-image: url('/krostu/img/marketing.png');">
        </div>

        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold text-gray-900">Услуги маркетолога</h1>
            <p class="mt-2 text-gray-600">Подписка на советы и проверка их выполнения для вашего сайта, бренда и личного
                бренда</p>
        </div>
    </header>


    <div class="container mx-auto my-8 mx-auto p-6 space-y-12">
...
container
    mx-auto my-10 px-4 sm:px-6 lg:px-8">
        ...
        gap-4">
            ...
            <section
                class="mt-16 bg-white p-8 rounded-lg shadow flex flex-col sm:flex-row items-center gap-6 max-w-4xl mx-auto">
                <div class="flex-1">
                    <h3 class="text-2xl font-semibold text-gray-900 mb-4">Преимущества добавления в работу
                        маркетолога</h3>
            ...
            <section class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-700 mb-6">Получите советы для продвижения и оптимизации сайта с регулярной
                        проверкой выполнения рекомендаций.</p>
                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-700 mb-6">Подписка с расширенным набором советов по развитию и укреплению бренда
                        с контрольными точками.</p>
                    <ul class="mb-6 space-y-2 text-gray-600">
                ...
                <div class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition-shadow">
                    ...
                    <p class="text-gray-700 mb-6">Индивидуальный подход к развитию личного бренда с советами и проверкой
                        их применения.</p>
                    <ul class="mb-6 space-y-2 text-gray-600">
                    ...
                    <button class="w-full bg-pink-600 text-white py-2 rounded hover:bg-pink-700 transition">
                        Подписаться
                    </button>
                </div>
            </section>

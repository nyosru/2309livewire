                ...
                md:text-left md:flex-row py-3 items-top justify-center">
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/4 mb-4">
                            <div class="flex items-center mb-4">
                                ...
                                @if(1==2)
                                    <img src="/cfa/img/logo.svg" class="w-[70%] mx-auto"/>
                                    ...
                                    <div class="flex-1 items-center align-middle">
                                        ...
                                        <a href="/" class="text-xl font-bold hover:underline"
                                           title="Центр финансовой аналитики">
                                            <img src="/cfa/img/logo.svg" alt="logo"
                                                 class="h-[4rem] inline mt-[0.5rem]"/>
                                        </a>
                                    </div>
                    ...
                    ">Ваши&nbsp;решения,<br/>наш&nbsp;опыт, скорость<br/>и&nbsp;точность.</p>
                        ...
                        <div class="w-full md:w-1/2 md:mt-3 lg:w-1/4 mb-4">
                            ...
                            <ul class="xspace-y-1">
                                ...
                                <li><a href="{{ route('cfa.news.index') }}"
                                       class="block p-1 hover:bg-blue-200">Новости</a>
                                </li>
            ...
            <div class="mx-auto container ">
                ...
                <div class="flex flex-col space-y-3  ">
                    ...
                    <div class="flex flex-col space-y-3 sm:space-y-0 sm:flex-row">
                        <div class="w-full sm:w-3/4 text-center items-center justify-center">
                            &copy; Все права защищены 2017-{{ date('Y') }}
                            <br/>
                            {{--                            Тех поддержка: <a--}}

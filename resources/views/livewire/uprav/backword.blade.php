<div>
    ...
    @if( !empty($warning) )
    <div class="alert bg-yellow-300 px-5 py-2 rounded">  {{ $warning }}  </div>
    @endif
    ...
    <form wire:submit="save">
        ...
        <button type="submit" class="button bg-blue-600 hover:bg-blue-800 rounded-lg px-4 py-2 text-white">Отправить
        </button>
    </form>
</div>

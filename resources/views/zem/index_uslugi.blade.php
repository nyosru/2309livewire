<div class="чcontainer mx-auto w-full xl:w-10/12 mx-auto xxstriped-background ">
    ...
    <div class="flex flex-wrap">
        <div class="w-full md:w-1/2 p-4">
            ...
            <br/>
            <br/>
            <h2 class="">Стоимость: <span class="bg-orange-200 font-bold px-2 py-1">14`900 р</span></h2>
            <br/>
            <br/>
        ...
        <div class="w-full md:w-1/2 p-4">
            ...
            <ul class="ulul">
                ...
                <li>Оплата первой части - 4`950 р</li>
                <li>
                    ...
                    <ul>
                        ...
                        <li>Когда примут документы, вам дадут 2 листка (информационный и опись) их фото пришлёте в Телеграм/Viber/WathsApp</li>
                    </ul>
                </li>
                <li>Получаем результат это шага (важный момент, может быть отказ/замечания)</li>
                <li>Оплата второй части - 9`950 р</li>

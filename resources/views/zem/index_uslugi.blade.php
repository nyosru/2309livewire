    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 p-4">
            ...
            <ul class="ulul">
                ...
                <li>
                    Идёте в МФЦ и подаёте заявления и подготовленных документов на первый этап приватизации гаража по амнистии
                    <ul>
                ...
                <li>Идёте в МФЦ и подаёте заявления и подготовленных документов на второй этап приватизации гаража по амнистии
                    <ul>
                        <li>Когда примут документы, вам дадут 2 листка (информационный и опись) их фото пришлёте в Телеграм/Viber/WathsApp</li>
                    </ul>
                </li>

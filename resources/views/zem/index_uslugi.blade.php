...
{{--            <br/>--}}
{{--            <br/>--}}
{{--            <h2 class="">Стоимость: <span class="bg-orange-200 font-bold px-2 py-1">10 р</span></h2>--}}
            <br/>
            <br/>
            <h2 class="text-3xl">Условия для приватизации:</h2>
            <ul class="ulul">
                <li>Гараж одноэтажный</li>
                <li> Гараж ж.б (стены и крыша из плит, кирпича)</li>
                <li>Гараж находится в гаражном кооперативе (много участников, есть председатель)</li>
                <li> Уплачены взносы в копператив, нет задолженности</li>
            </ul>
        </div>
        <div class="w-full md:w-1/2 p-4">
            ...
            <ul class="ulul">
                <li>Предоставляете данные (в
                    ...
                    <ul>
                        ...
                        <li>
                            справка от председателя,
                        </li>
                        <li>
                            паспорт
                            владельца (кто указан в справке)
                        </li>
                    </ul>
                </li>
                <li>Оплата первой части</li>
                <li>
                    Подаёте в МФЦ заявления и подготовленных документов на первый этап приватизации гаража по амнистии
                    <ul>
                        <li>Указываете что результат хотите получить на email 777@php-cat.com</li>
                        <li>Когда примут документы, вам дадут 2 листка (информационный и опись) их фото пришлёте в Vk.com</li>
                    </ul>
                </li>
                <li>Получаем результат это шага (важный момент, может быть отказ/замечания)</li>
                <li>Оплата второй части</li>
                <li>Подаёте в МФЦ  заявления и подготовленных документов на второй этап приватизации гаража по амнистии
                    <ul>
                        <li>Когда примут документы, вам дадут 2 листка (информационный и опись) их фото пришлёте в Vk</li>
                    </ul>
                </li>
                <li>Как получим результат по второму шагу, мы передадим Заявления и данные на третий этап</li>
                <li>Получаем результат и Готово, <b>гараж и земля под ним Ваши!</b> (подтверждается выпиской которую получите в своих
                    гос.услугах или мфц)
                </li>
            </ul>
        </div>
    ...
    <div class="flex flex-wrap">
        <div class="w-full xxmd:w-1/2 p-4">
            <img src="/zem/sud.jpg" class="float-left pr-2"/>
            <div class="bg-blue-100 py-2">
                <h2 class="text-3xl ml-4 inline-block">Если над или под гаражом ещё один гараж</h2>
            </div>
            <p class="py-4 ml-4 ">
                Если владельцы разные на разных этажах, то:
                <br/>
                <span class="bg-red-100 p-1">- не получится приватизировать землю</span>
                <br/>
                <span class="bg-green-100 p-1">+ получится приватизировать строение через суд </span>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6"><!--v-if-->
                    <div class="pb-5 text-center"><img src="/phpcat/ya5.jpg" alt="..." class="ya"><a
                            href="#">показать
                            другую фотку и
                            <svg style="width: 26px;" aria-hidden="true" focusable="false" data-prefix="fab"
                                 data-icon="empire" class="svg-inline--fa fa-empire fa-w-16" role="img"
                ...
                <div class="col-12 col-md-6">
                    <h2 class="alert alert-warning text-center"> {{ date('Y') }}&nbsp;год самое&nbsp;время реализовать
                        вашу&nbsp;идею!
                    </h2>
                    <p class="text-center"> Я&nbsp;Сергей&nbsp;Бакланов <br><br> Младший помощник программиста,
                        Програмист,
                    ...
                    <h2 class="alert xalert-info text-center"> Позвоните и&nbsp;обсудим <br clear="all"><small>(или
                            напишите
                            Телеграм/Viber/WA)</small><br clear="all"><a href="tel:+79222622289"> тел:
        ...
        <div class="px-6 py-12 text-center md:px-12 lg:text-left">
            <div class="w-100 mx-auto sm:max-w-2xl md:max-w-3xl lg:max-w-5xl xl:max-w-7xl">
                ...
                <h1
                    ...
                    {{ date('Y') }}&nbsp;год самое&nbsp;время юридически оформить гараж!
                </h1>

<div class="container mx-auto">
    ...
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-1/2 p-4">
            ...
            <ul class="ulul">
                <li>Предоставляете данные (в телеграм, ватсап): фото гаража снаружи, справка от председателя, паспорт
                    владельца (кто указан в справке)
                </li>
                <li>Оплата первой части - 5`000 р</li>
                <li>Передача в МФЦ заявления и подготовленных документов</li>
                <li>Получить в МФЦ ответ по первому заявлению (важный момент, может быть отказ/замечания)</li>
                <li>Оплата второй части - 8`000 р</li>
                <li>Передача в МФЦ подготовленных документов</li>

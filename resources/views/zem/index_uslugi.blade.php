            ...
            <ul class="ulul">
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>пришлёте фото описи и информационного листка в Телеграм/Viber/WathsApp</li>
                    </ul>
                </li>
                <li>Получаем результат это шага (важный момент, может быть отказ/замечания)</li>
                <li>Оплата второй части - 8`000 р</li>
                <li>Передача в МФЦ подготовленных документов
                    <ul>
                        <li>пришлёте фото описи и информационного листка в Телеграм/Viber/WathsApp</li>
                    </ul>
                </li>
                <li>Мы передадим дополнительно, Заявления и данные в нужные ведомства</li>
                <li>Готово, <b>гараж и земля под ним Ваши!</b> (подтверждается выпиской которую получите в своих
                    гос.услугах или мфц)
                </li>
            </ul>
        </div>

...
@elseif(
    $_SERVER['HTTP_HOST'] == 'commutator.local' ||
    $_SERVER['HTTP_HOST'] == 'commutator.localar.php-cat.com'
//    ||
//    $_SERVER['HTTP_HOST'] == 'php-cat.local' ||
//    $_SERVER['HTTP_HOST'] == 'livewire.php-cat.local' ||
//    $_SERVER['HTTP_HOST'] == 'livewire.php-cat.com'
    ...
    @include('uprav-communicator.index')
...
@else
    ...
    @if(1==2)
        ...
        <div class="bg-green-800 p-5">
            <nav>
                <a href="/p1" class="py-1 px-3 {{ Route::currentRouteName() == 'p1' ? 'bg-red-700' : 'bg-gray-700' }}"
                   wire:navigate>Dashboard</a>
                <a href="/p2" class="py-1 px-3 {{ Route::currentRouteName() == 'p2' ? 'bg-red-700' : 'bg-gray-700' }}"
                   wire:navigate>Posts</a>
                <a href="/p3" class="py-1 px-3 {{ Route::currentRouteName() == 'p3' ? 'bg-red-700' : 'bg-gray-700' }}"
                   wire:navigate>Users</a>
            </nav>
        </div>


        {{ Route::currentRouteName() ?? 'cx' }}
        {{ $level ?? 'cx' }}
        ...
        <audio src="https://download.samplelib.com/mp3/sample-15s.mp3" controls></audio>
        @endpersist
        <br/>
        <br/>
        <div style="max-width: 500px;">
            @persist('player')
            {{-- <audio src="{{ $episode->file }}" controls></audio> --}}
            <video src="https://download.samplelib.com/mp4/sample-20s.mp4" controls></video>
            @endpersist
        </div>
        <br/>
        <br/>
        ...
        <h1 class="bg-orange-200">showPosts</h1>
        <livewire:showPosts/>
        <br/>
        <br/>

        <h1 class="bg-orange-200">showPostsSearch</h1>
        <livewire:showPostsSearch/>
        <br/>
        <br/>
        <br/>
        @livewireScripts
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-gray-900">Vibrant
                                    Ecosystem</h2>

...
class IndexComponent extends Component
{
    ...
    public $services = [
        ['slug' => 'on-site', 'title' => 'Выездная настройка', 'sub' => 'Бесплатные + платные модели', 'desc' => 'Приезжаем, настраиваем ИИ под ваши задачи. Вы платите за настройку и модели (если выбрали платные).', 'icon' => '🚀', 'price' => 'от 25 000 ₽'],
        ['slug' => 'local-ai', 'title' => 'Локальные модели', 'sub' => 'На вашем сервере', 'desc' => 'ИИ работает на вашем оборудовании (круто если есть мак на процессоре М* с 16+ Гб памяти. Все данные остаются у вас. Полная приватность.', 'icon' => '🖥️', 'price' => 'от 25 000 ₽'],

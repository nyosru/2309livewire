...
$d = function () {
    ...
    Route::group([
        ...
        Route::get('token-check', [AiController::class, 'checkToken'])->name('token.check');

        Route::get('token', [AiController::class, 'getToken'])->name('token');
...
//Route::group([
//    'as' => 'phpcat.',
//    'domain' => (env('APP_ENV', 'local') == 'local') ? 'phpcat.local' : 'xn--80aeiaarcmpbmdnb6aghgm9nrc.xn--p1ai'
//], $d);
